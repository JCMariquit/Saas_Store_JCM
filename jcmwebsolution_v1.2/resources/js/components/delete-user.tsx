            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex min-w-0 items-start gap-3">
                    ...
                    <div className="min-w-0">
                        <p className="text-foreground text-sm font-semibold">Remove this account</p>
                        <p className="text-muted-foreground mt-1 max-w-2xl text-[10px] leading-5">
                            This permanently removes your sign-in access and signs you out. Required platform records may be retained for audit
                            integrity.
                        </p>
                    </div>
                </div>
                ...
                <Dialog>
                    ...
                    <DialogContent>
                        ...
                        <DialogDescription>
                            Your sign-in access will be permanently removed and you will be signed out. Enter your current password to confirm.
                        </DialogDescription>
                        ...
                        <form className="space-y-5" onSubmit={deleteUser}>
                            ...
                            <DialogFooter>
                                ...
                                <Button type="submit" variant="destructive" disabled={processing}>
                                    <Trash2 className="size-3.5" />
                                    {processing ? 'Removing...' : 'Permanently remove'}
                                </Button>
                            </DialogFooter>
                        </form>
                    </DialogContent>
