        ...
        return [
            ...
            [
                ...
                'items' => [
                    ...
                    ['key' => 'integrations-api', 'title' => 'Integrations & API', 'url' => '#', 'icon' => 'PlugZap', 'badge' => 'SOON'],
                ],
            ],
            [
                'key' => 'accounts',
                ...
                'items' => [
                    ...
                    ['key' => 'roles-permissions', 'title' => 'Roles & Permissions', 'url' => '#', 'icon' => 'ShieldUser', 'badge' => 'SOON'],
                ],
            ],
            [
                'key' => 'catalog-plans',
                ...
                'items' => [
                    ...
                    ['key' => 'subscription-policies', 'title' => 'Subscription Policies', 'url' => '/admin/subscription-policies', 'icon' => 'FileKey2', 'badge' => null],
                    ['key' => 'feature-flags', 'title' => 'Feature Flags', 'url' => '#', 'icon' => 'Flag', 'badge' => 'SOON'],
                ],
            ],
            [
                'key' => 'sales-billing',
                ...
                'items' => [
                    ...
                    ['key' => 'invoices', 'title' => 'Invoices', 'url' => '#', 'icon' => 'FileText', 'badge' => 'SOON'],
                    ['key' => 'refunds', 'title' => 'Refunds', 'url' => '#', 'icon' => 'RotateCcw', 'badge' => 'SOON'],
                ],
            ],
            [
                'key' => 'operations',
                ...
                'collapsible' => true,
                'items' => [
                    ['key' => 'support-tickets', 'title' => 'Support Tickets', 'url' => '#', 'icon' => 'TicketCheck', 'badge' => 'SOON'],
                    ['key' => 'system-health', 'title' => 'System Health', 'url' => '#', 'icon' => 'Activity', 'badge' => 'SOON'],
                ],
            ],
            [
                'key' => 'governance',
                ...
                'items' => [
                    ...
                    ['key' => 'website-builder', 'title' => 'Website Builder', 'url' => '/admin/website/builder', 'icon' => 'Globe2', 'badge' => null],
                ],
            ],
        ];
    }
