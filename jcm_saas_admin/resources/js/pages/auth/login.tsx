                        ...
                        <div className="relative flex flex-col justify-between">
                            <div>
                                ...
                                <p className="mt-4 max-w-[560px] text-base leading-7 text-slate-500 sm:text-lg">
                                    Access the internal control panel for JCM Web Solution. This portal is
                                    intended only for authorized administrators managing systems, clients,
                                    products, and platform operations.
                                </p>
                            ...
                            <div className="mt-8 rounded-[24px] border border-white/60 bg-gradient-to-b from-white/80 to-white/55 p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.6)]">
                                ...
                                <div className="rounded-[20px] border border-blue-200/80 bg-gradient-to-br from-blue-50 to-white p-5">
                                    <div className="flex items-center justify-between gap-3">
                                        <div className="text-sm font-bold text-slate-900">Admin Overview</div>
                        ...
                        <div className="flex items-center">
                            <div className="w-full rounded-[28px] border border-white/60 bg-white/80 p-6 shadow-[0_25px_60px_rgba(15,23,42,0.12)] backdrop-blur-[20px] sm:p-8">
                                ...
                                <form className="mt-6 flex flex-col gap-5" onSubmit={submit}>
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            {canResetPassword && (
                                                <TextLink
                                                    ...
                                                    className="ml-auto text-sm text-sky-700 hover:text-sky-800"
                                                    tabIndex={5}
                                                >
                                                    Forgot password?
                                                </TextLink>
                                    ...
                                    <div className="flex items-center space-x-3 rounded-2xl border border-slate-200/80 bg-slate-50/80 px-4 py-3">
                                        <Checkbox
                                            id="remember"
                                            name="remember"
                                            tabIndex={3}
                                        ...
                                        />
                                        <Label htmlFor="remember" className="cursor-pointer text-sm text-slate-700">
                                            Remember me
                                        </Label>
                                    </div>
