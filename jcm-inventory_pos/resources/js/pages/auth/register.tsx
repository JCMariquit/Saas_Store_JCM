        ...
        <>
            ...
            <div className="flex min-h-screen items-center justify-center bg-[#eef1f6] px-4 py-10">
                <div className="grid w-full max-w-[940px] overflow-hidden rounded-[22px] bg-white shadow-[0_24px_70px_rgba(15,23,42,0.18)] md:grid-cols-[1fr_1.05fr]">
                    <div className="relative hidden min-h-[620px] overflow-hidden bg-gradient-to-br from-blue-700 via-blue-600 to-sky-500 px-10 py-10 text-white md:block">
                        ...
                        <div className="relative z-20 flex h-full flex-col">
                            ...
                            <div className="mt-20 flex flex-col items-center text-center">
                                ...
                                <p className="mt-4 max-w-[300px] text-sm leading-6 text-white/80">
                                    Create your secure workspace account for JCM
                    ...
                    <div className="flex min-h-[620px] flex-col justify-center px-7 py-10 sm:px-12">
                        <div className="mx-auto w-full max-w-[360px]">
                            <div className="mb-7">
                                ...
                                <p className="mt-2 text-sm leading-6 text-slate-500">
                                    Set up your JCM workspace access.
                                </p>
                            </div>
                                ...
                                <div className="rounded-[14px] border border-slate-200 bg-slate-50 px-4 py-3">
                                    <div className="flex gap-3">
                                        ...
                                        <p className="text-xs leading-5 text-slate-500">
                                            Your account will be protected under
                                            JCM workspace access.
                                        </p>
                                    </div>
                                </div>
