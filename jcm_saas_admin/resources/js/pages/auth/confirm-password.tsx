                        ...
                        <div className="relative flex flex-col justify-between">
                            <div>
                                ...
                                <p className="mt-4 max-w-[560px] text-base leading-7 text-slate-500 sm:text-lg">
                                    This is a protected section of the internal administration area.
                            ...
                            <div className="mt-8 rounded-[24px] border border-white/60 bg-gradient-to-b from-white/80 to-white/55 p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.6)]">
                                ...
                                <div className="rounded-[20px] border border-blue-200/80 bg-gradient-to-br from-blue-50 to-white p-5">
                                    <div className="flex items-center justify-between gap-3">
                                        <div className="text-sm font-bold text-slate-900">Verification Panel</div>
                                    ...
                                    <div className="mt-5 grid gap-3">
                                        <div className="relative h-[14px] overflow-hidden rounded-full bg-gradient-to-r from-sky-500/20 to-blue-600/10 after:absolute after:inset-y-0 after:left-0 after:w-[66%] after:rounded-full after:bg-gradient-to-r after:from-sky-500 after:to-blue-600 after:opacity-80" />
                                        <div className="relative h-[14px] overflow-hidden rounded-full bg-gradient-to-r from-sky-500/20 to-blue-600/10 after:absolute after:inset-y-0 after:left-0 after:w-[76%] after:rounded-full after:bg-gradient-to-r after:from-sky-500 after:to-blue-600 after:opacity-80" />
                                        <div className="relative h-[14px] overflow-hidden rounded-full bg-gradient-to-r from-sky-500/20 to-blue-600/10 after:absolute after:inset-y-0 after:left-0 after:w-[54%] after:rounded-full after:bg-gradient-to-r after:from-sky-500 after:to-blue-600 after:opacity-80" />
                                    </div>

                                    <div className="mt-5 grid gap-3 sm:grid-cols-2">
                                        <div className="rounded-[18px] border border-blue-200/70 bg-white/80 p-4 shadow-[0_10px_24px_rgba(14,165,233,0.06)]">
                                            <strong className="block text-[22px] text-slate-900">Identity</strong>
                                    ...
                                    <div className="mt-5 flex items-center gap-3 text-sm text-slate-500">
                                        ...
                                        Password confirmation is required before sensitive actions
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="w-full rounded-[28px] border border-white/60 bg-white/80 p-6 shadow-[0_25px_60px_rgba(15,23,42,0.12)] backdrop-blur-[20px] sm:p-8">
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="mt-2 text-sm leading-6 text-slate-500">
                                        Re-enter your current password to continue to this protected area.
                                    </p>
                                </div>
                                ...
                                <form onSubmit={submit} className="mt-6">
                                    <div className="space-y-5">
                                        ...
                                        <div className="flex items-center">
                                            <Button
                                                type="submit"
                                                className="h-12 w-full rounded-2xl bg-gradient-to-r from-sky-500 to-blue-600 text-sm font-bold text-white shadow-[0_16px_35px_rgba(37,99,235,0.24)] transition duration-200 hover:-translate-y-0.5 hover:from-sky-500 hover:to-blue-700"
                                                disabled={processing}
                                            >
                                                {processing && (
