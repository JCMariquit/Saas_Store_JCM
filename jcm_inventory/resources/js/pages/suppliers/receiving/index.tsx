    ...
    const voidedPercentage =
        summary.total > 0
            ? Math.min(
                  100,
                  Math.round(
                      (summary.voided / summary.total) * 100,
                  ),
              )
            : 0;
    ...
    */
    ...
    const receiptColumns: DataTableColumn<Receipt>[] = [
                ...
                <EntityInfo
                    ...
                    badges={
                        receipt.can_void ? (
                            <Badge
                                variant="outline"
                                className="h-5 rounded-full border-emerald-500/15 bg-emerald-500/[0.06] px-2 text-[9px] font-semibold text-emerald-300"
                            >
                                REVERSIBLE
                            </Badge>
                            ...
                            <Badge
                                variant="outline"
                                className="h-5 rounded-full border-red-500/15 bg-red-500/[0.06] px-2 text-[9px] font-semibold text-red-300"
                            >
                                REVERSED
                            </Badge>
                        ) : undefined
                    ...
                    description={
                        receipt.received_by
                            ? `Received by ${receipt.received_by.name}`
                ...
                <div className="flex items-start gap-2.5">
                    ...
                    <div className="min-w-0">
                        ...
                        <p className="mt-1 text-[9px] text-muted-foreground">
                            ...
                            {receipt.items_count === 1 ? '' : 's'} received
                        </p>
                    </div>
                </div>
            ),
        },
        {
            ...
            cell: (receipt) => (
                <div className="flex items-start gap-2.5">
                    ...
                    <div className="min-w-0">
                        <p className="max-w-[170px] truncate text-[12px] font-semibold text-foreground/90">
                        ...
                        <div className="mt-1 flex flex-wrap items-center gap-1.5">
                            ...
                            >
                                {receipt.supplier.code ?? 'NO CODE'}
                            </Badge>

                            {receipt.supplier.contact_person && (
                                <span className="max-w-[105px] truncate text-[9px] text-muted-foreground">
                                    {receipt.supplier.contact_person}
                                </span>
                            )}
                        </div>
            ...
            cell: (receipt) => (
                <div className="space-y-2">
                    <div className="flex items-center gap-2">
                        ...
                        <div className="min-w-0">
                            <p className="max-w-[160px] truncate text-[11px] font-semibold">
                                {receipt.warehouse.name}
                            </p>

                            <p className="font-mono text-[9px] text-muted-foreground">
                                {receipt.warehouse.code ?? 'No warehouse code'}
                            </p>
                        </div>
                    </div>
        ...
        },
        {
            ...
            cell: (receipt) => (
                <div className="flex items-center gap-2">
                    <span className="inline-flex size-7 shrink-0 items-center justify-center rounded-lg bg-emerald-500/10 text-emerald-400">
            ...
            <PageContainer className="gap-4 md:gap-5">
                        ...
                        <div className="flex min-w-0 items-center gap-3">
                            ...
                            <div className="min-w-0">
                                ...
                                <p className="mt-0.5 text-[10px] text-muted-foreground">
                                    Posted deliveries, warehouse intake, received value, and reversal health.
                                </p>
                            </div>
                        </div>
                ...
                >
                    ...
                    <DataTable
                        ...
                        emptyDescription="Posted supplier deliveries will appear here after inventory is received against an approved purchase order."
                        emptyAction={
                            purchase_orders.length > 0 ? (
                    ...
                    <section className="overflow-hidden rounded-xl border border-amber-500/10 bg-amber-500/[0.025]">
                        ...
                        <div className="grid sm:grid-cols-2 xl:grid-cols-4">
                            <ReceiptContextMetric
                                ...
                                detail={selectedPurchaseOrder.supplier.code ?? 'No supplier code'}
                                icon={Truck}
                                tone="amber"
                                className="border-b border-border/60 sm:border-r xl:border-b-0"
                            />
                            ...
                            <section className="overflow-hidden rounded-xl border border-amber-500/10 bg-amber-500/[0.025]">
                                ...
                                <div className="grid sm:grid-cols-2">
                                    ...
                                    <ReceiptContextMetric
                                        ...
                                        detail={viewingReceipt.delivery_reference ?? 'No delivery reference'}
                                        icon={CalendarDays}
                                        tone="blue"
