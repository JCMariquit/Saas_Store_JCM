...
use App\Http\Controllers\Staff\Manager\ManagerInventoryReportController;
...
use App\Http\Controllers\Staff\Manager\ManagerSalesReportController;
        ...
        ->group(function () {
            ...
            Route::middleware(['role:manager'])
                ...
                ->group(function () {
                    ...
                    Route::resource('/categories', ManagerCategoryController::class)->except(['create', 'show', 'edit'])->names('categories');
                    ...
                    Route::get('/reports/sales', [ManagerSalesReportController::class, 'index'])->name('reports.sales.index');
                    Route::get('/reports/inventory', [ManagerInventoryReportController::class, 'index'])->name('reports.inventory.index');
                });

            /* Staff / General Staff Routes */
