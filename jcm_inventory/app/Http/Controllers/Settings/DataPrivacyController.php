...
class DataPrivacyController extends Controller
{
    public function index(Request $request): Response
    {
        ...
        $loginActivityCount = Schema::connection('saas')->hasTable('login_activities')
    ...
    public function export(Request $request): StreamedResponse
    {
        ...
        $activities = Schema::connection('saas')->hasTable('login_activities')
            ? LoginActivity::query()
                ->where('user_id', $user->getKey())
        ...
        $filename = sprintf(
            'jcm-inventory-account-data-%s.json',
