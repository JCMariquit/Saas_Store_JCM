...
export function AppSidebarHeader({
    ...
    return (
        <>
            <header className="jcm-app-header relative z-20 mx-4 mt-4 flex h-[68px] shrink-0 items-center justify-between rounded-[15px] border border-black/[0.08] bg-sidebar px-5 shadow-[0_8px_30px_rgba(0,0,0,0.03)] ring-1 ring-black/[0.03] backdrop-blur-md transition-all duration-300 dark:border-white/[0.10] dark:ring-white/[0.04] group-has-data-[collapsible=icon]/sidebar-wrapper:h-14 md:px-4">
