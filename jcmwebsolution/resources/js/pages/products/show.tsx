                        ...
                        <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
                            <div>
                                ...
                                <p className="mt-1 text-sm text-slate-500">
                                    Show your plan options here before the customer places an order.
                                </p>
                            </div>
                        </div>
                                ...
                                product.plans.map((plan) => (
                                    ...
                                    >
                                        <div className="flex items-start justify-between gap-3">
                                            ...
                                            <span
                                                className={`inline-flex rounded-full border px-2.5 py-1 text-[11px] font-semibold capitalize ${planStatusBadgeClass(
                                                    plan.status,
                                                )}`}
                                            >
                                                {plan.status}
                                        ...
                                        <div className="mt-5">
                                            ...
                                            {plan.features.length > 0 ? (
                                                ...
                                                <p className="mt-3 text-sm text-slate-500">
                                                    No feature list added for this plan yet.
                                                </p>
                                            )}
                                        </div>
