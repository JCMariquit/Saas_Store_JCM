                        ...
                        <div className="flex min-w-0 items-center gap-3.5">
                            ...
                            <div className="min-w-0">
                                ...
                                <p className="text-muted-foreground mt-1 max-w-2xl text-xs leading-5">
                                    Permanently remove your signed-in user account.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="grid min-w-0 lg:grid-cols-[280px_minmax(0,1fr)]">
                        <aside className="border-border/60 bg-background/20 border-b p-5 lg:border-r lg:border-b-0">
                            ...
                            <div className="border-border/60 mt-5 space-y-3 border-y py-4">
                                <RemovalFact icon={UserX} text="Your user profile will be deleted." />
                                <RemovalFact icon={ShieldAlert} text="You will be signed out immediately." />
                                <RemovalFact icon={Database} text="Operational records may remain for audit integrity." />
                            </div>
                        </aside>

                        <div className="min-w-0 p-5 md:p-6">
                            <div className="mb-5">
                                <p className="text-foreground text-sm font-semibold">Confirm account deletion</p>
                                <p className="text-muted-foreground mt-1 text-xs leading-5">Password confirmation is required before deletion.</p>
                            </div>
