        ...
        <>
            ...
            <div className="min-h-screen overflow-x-hidden bg-[#e8e9eb] text-slate-900">
                ...
                <main className="space-y-6 overflow-x-hidden">
                    <section className="relative overflow-hidden border-b border-slate-800 bg-gradient-to-r from-slate-900 to-slate-800 text-white">
                        <div className="mx-auto max-w-7xl px-5 py-6 md:px-7 md:py-8 lg:grid lg:grid-cols-[1.08fr_0.92fr] lg:items-center lg:gap-6">
                            <div className="max-w-3xl">
                                ...
                                <h1 className="mt-4 max-w-2xl text-2xl font-bold leading-tight text-white md:text-3xl xl:text-4xl">
                                    Upgrade your business with ready-made and custom digital
                                    solutions
                                </h1>
                        ...
                        >
                            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
                                <div>
                                    ...
                                    <p className="mt-1 text-sm text-slate-500">
                                        Tailored services for clients who need custom development
                            ...
                            <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                                ...
                                <div className="flex flex-wrap gap-4">
                                    ...
                                    {canRegister && (
                                        <Link
                                            href="/register"
                                            className="inline-flex items-center justify-center rounded-2xl border border-white/30 px-6 py-3 text-sm font-semibold text-white"
                                        >
                                            Sign Up
                                        </Link>
                                    )}
