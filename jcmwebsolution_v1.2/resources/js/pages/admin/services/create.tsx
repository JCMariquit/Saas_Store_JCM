                        ...
                        <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                            <div className="max-w-3xl">
                                ...
                                <p className="mt-3 max-w-2xl text-sm leading-7 text-slate-300 md:text-base">
                                    Add a new service, upload images, organize its highlights,
                                    and prepare the overview content for your storefront.
                                </p>
                            </div>
                                        ...
                                        <div>
                                            ...
                                            <select
                                                ...
                                                onChange={(e) =>
                                                    form.setData(
                                                        'service_type',
                                                        e.target.value as ServiceFormData['service_type'],
                                                    )
                                                }
                                            >
                                    ...
                                    <div className="grid gap-5 md:grid-cols-3">
                                        ...
                                        <div>
                                            ...
                                            <Input
                                                ...
                                                placeholder="0.00"
                                                disabled={form.data.pricing_type === 'quote'}
                                            />
