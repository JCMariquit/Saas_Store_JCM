                    ...
                    <div className="grid w-full max-w-6xl gap-6 overflow-hidden rounded-[30px] border border-white/60 bg-white/70 p-6 shadow-[0_25px_60px_rgba(15,23,42,0.12)] backdrop-blur-[20px] md:grid-cols-[1.05fr_0.95fr] md:p-8 lg:p-9">
                        ...
                        <div className="relative flex flex-col justify-between">
                            <div>
                                ...
                                <p className="mt-4 max-w-[560px] text-base leading-7 text-slate-500 sm:text-lg">
                                    Enter your administrator email address to receive a secure password
                                    reset link and continue access to the internal control panel.
                                </p>
                            ...
                            <div className="mt-8 rounded-[24px] border border-white/60 bg-gradient-to-b from-white/80 to-white/55 p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.6)]">
                                ...
                                <div className="rounded-[20px] border border-blue-200/80 bg-gradient-to-br from-blue-50 to-white p-5">
                                    <div className="flex items-center justify-between gap-3">
                                        <div className="text-sm font-bold text-slate-900">Recovery Status</div>
                                    ...
                                    <div className="mt-5 grid gap-3">
                                        <div className="relative h-[14px] overflow-hidden rounded-full bg-gradient-to-r from-sky-500/20 to-blue-600/10 after:absolute after:inset-y-0 after:left-0 after:w-[74%] after:rounded-full after:bg-gradient-to-r after:from-sky-500 after:to-blue-600 after:opacity-80" />
                                        ...
                                        <div className="relative h-[14px] overflow-hidden rounded-full bg-gradient-to-r from-sky-500/20 to-blue-600/10 after:absolute after:inset-y-0 after:left-0 after:w-[82%] after:rounded-full after:bg-gradient-to-r after:from-sky-500 after:to-blue-600 after:opacity-80" />
                                    </div>
                                    ...
                                    <div className="mt-5 flex items-center gap-3 text-sm text-slate-500">
                                        ...
                                        Reset links are intended for authorized administrator accounts
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center">
                            <div className="w-full rounded-[28px] border border-white/60 bg-white/80 p-6 shadow-[0_25px_60px_rgba(15,23,42,0.12)] backdrop-blur-[20px] sm:p-8">
                                ...
                                {status && (
                                    <div className="mt-6 rounded-2xl border border-green-200 bg-green-50 px-4 py-3 text-center text-sm font-medium text-green-600">
                                        {status}
                                    </div>
                                )}
